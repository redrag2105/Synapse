...
class AuthorDetailHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  static const double expandedBodyHeight = 236;

  static double get statsOverlap => JournalDetailStatsCard.layoutHeight / 2;

  AuthorDetailHeaderDelegate({
  ...
  @override
  bool shouldRebuild(covariant AuthorDetailHeaderDelegate oldDelegate) {
    return oldDelegate.topPadding != topPadding ||
        oldDelegate.displayName != displayName ||
        oldDelegate.institution != institution ||
        oldDelegate.orcid != orcid ||
        oldDelegate.topicLabel != topicLabel ||
